# Comparing `tmp/cudf_cu11-24.4.0.tar.gz` & `tmp/cudf_cu11-24.4.1.tar.gz`
...
+gzip compressed data, was "cudf_cu11-24.4.1.tar", last modified: Mon Apr  5 07:00:00 1993, max compression
```

## Comparing `cudf_cu11-24.4.0.tar` & `cudf_cu11-24.4.1.tar`
...
+-rw-r--r--   0        0        0     6034 1993-04-05 07:00:00.000000 PKG-INFO
```
...
+Requires-Dist: protobuf<5,>=3.20
 Requires-Dist: ptxcompiler-cu11
 Requires-Dist: pyarrow<15.0.0a0,>=14.0.1
 Requires-Dist: rich
 Requires-Dist: rmm-cu11==24.4.*
