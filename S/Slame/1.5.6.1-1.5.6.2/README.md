# Comparing `tmp/Slame-1.5.6.1.tar.gz` & `tmp/Slame-1.5.6.2.tar.gz`
...
## Comparing `Slame-1.5.6.1.tar` & `Slame-1.5.6.2.tar`
...
### Comparing `Slame-1.5.6.1/PKG-INFO` & `Slame-1.5.6.2/PKG-INFO`
...
### Comparing `Slame-1.5.6.1/README.md` & `Slame-1.5.6.2/README.md`

 * *Files identical despite different names*

### Comparing `Slame-1.5.6.1/Slame/slame.py` & `Slame-1.5.6.2/Slame/slame.py`
...
### Comparing `Slame-1.5.6.1/Slame.egg-info/PKG-INFO` & `Slame-1.5.6.2/Slame.egg-info/PKG-INFO`
...
### Comparing `Slame-1.5.6.1/setup.py` & `Slame-1.5.6.2/setup.py`
