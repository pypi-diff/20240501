# Comparing `tmp/scrapkit-1.1.tar.gz` & `tmp/scrapkit-1.2.tar.gz`
...
## Comparing `scrapkit-1.1.tar` & `scrapkit-1.2.tar`
...
### Comparing `scrapkit-1.1/scrapkit/main.py` & `scrapkit-1.2/scrapkit/main.py`
