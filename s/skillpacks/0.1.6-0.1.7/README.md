# Comparing `tmp/skillpacks-0.1.6.tar.gz` & `tmp/skillpacks-0.1.7.tar.gz`
...
### Comparing `skillpacks-0.1.6/skillpacks/auth/key.py` & `skillpacks-0.1.7/skillpacks/auth/key.py`
