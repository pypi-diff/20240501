# Comparing `tmp/stopwords_tr-1.2.4.tar.gz` & `tmp/stopwords_tr-1.2.5.tar.gz`
...
## Comparing `stopwords_tr-1.2.4.tar` & `stopwords_tr-1.2.5.tar`
...
### Comparing `stopwords_tr-1.2.4/LICENSE` & `stopwords_tr-1.2.5/LICENSE`

 * *Files identical despite different names*

### Comparing `stopwords_tr-1.2.4/PKG-INFO` & `stopwords_tr-1.2.5/PKG-INFO`
...
### Comparing `stopwords_tr-1.2.4/setup.py` & `stopwords_tr-1.2.5/setup.py`
...
### Comparing `stopwords_tr-1.2.4/src/stopwords_tr/__init__.py` & `stopwords_tr-1.2.5/src/stopwords_tr/__init__.py`
...
### Comparing `stopwords_tr-1.2.4/src/stopwords_tr.egg-info/PKG-INFO` & `stopwords_tr-1.2.5/src/stopwords_tr.egg-info/PKG-INFO`
