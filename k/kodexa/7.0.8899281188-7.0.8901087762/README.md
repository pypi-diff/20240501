# Comparing `tmp/kodexa-7.0.8899281188.tar.gz` & `tmp/kodexa-7.0.8901087762.tar.gz`
...
### Comparing `kodexa-7.0.8899281188/kodexa/platform/kodexa.py` & `kodexa-7.0.8901087762/kodexa/platform/kodexa.py`
