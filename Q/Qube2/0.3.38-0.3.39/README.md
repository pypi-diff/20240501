# Comparing `tmp/Qube2-0.3.38.tar.gz` & `tmp/Qube2-0.3.39.tar.gz`
...
### Comparing `Qube2-0.3.38/Qube2.egg-info/SOURCES.txt` & `Qube2-0.3.39/Qube2.egg-info/SOURCES.txt`
...
### Comparing `Qube2-0.3.38/qube/booster/app/templates/detailed_report.html` & `Qube2-0.3.39/qube/booster/app/templates/detailed_report.html`
...
### Comparing `Qube2-0.3.38/qube/booster/simctrl.py` & `Qube2-0.3.39/qube/booster/simctrl.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/booster/utils.py` & `Qube2-0.3.39/qube/booster/utils.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/charting/highcharts/core.py` & `Qube2-0.3.39/qube/charting/highcharts/core.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/charting/highcharts/display.py` & `Qube2-0.3.39/qube/charting/highcharts/display.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/charting/lookinglass.py` & `Qube2-0.3.39/qube/charting/lookinglass.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/charting/mpl_finance.py` & `Qube2-0.3.39/qube/charting/mpl_finance.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/charting/plot_helpers.py` & `Qube2-0.3.39/qube/charting/plot_helpers.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/configs/Properties.py` & `Qube2-0.3.39/qube/configs/Properties.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/configs/config-default/datasource.json` & `Qube2-0.3.39/qube/configs/config-default/datasource.json`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/configs/config-default/dukas_outlook.csv` & `Qube2-0.3.39/qube/configs/config-default/dukas_outlook.csv`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/configs/config-test/datasource.json` & `Qube2-0.3.39/qube/configs/config-test/datasource.json`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/configs/config-test/dukas_outlook.csv` & `Qube2-0.3.39/qube/configs/config-test/dukas_outlook.csv`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/datasource/CsvConnector.py` & `Qube2-0.3.39/qube/datasource/CsvConnector.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/datasource/DataSource.py` & `Qube2-0.3.39/qube/datasource/DataSource.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/datasource/DataserverConnector.py` & `Qube2-0.3.39/qube/datasource/DataserverConnector.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/datasource/DukasOutlookConnector.py` & `Qube2-0.3.39/qube/datasource/DukasOutlookConnector.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/datasource/InMemoryDataSource.py` & `Qube2-0.3.39/qube/datasource/InMemoryDataSource.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/datasource/KdbConnector.py` & `Qube2-0.3.39/qube/datasource/KdbConnector.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/datasource/MongoConnector.py` & `Qube2-0.3.39/qube/datasource/MongoConnector.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/datasource/YahooConnector.py` & `Qube2-0.3.39/qube/datasource/YahooConnector.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/datasource/controllers/KdbServerController.py` & `Qube2-0.3.39/qube/datasource/controllers/KdbServerController.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/datasource/controllers/MemcacheController.py` & `Qube2-0.3.39/qube/datasource/controllers/MemcacheController.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/datasource/controllers/MongoController.py` & `Qube2-0.3.39/qube/datasource/controllers/MongoController.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/datasource/controllers/kdb_utils.py` & `Qube2-0.3.39/qube/datasource/controllers/kdb_utils.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/datasource/loaders.py` & `Qube2-0.3.39/qube/datasource/loaders.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/examples/booster/test_portfolio_task.yml` & `Qube2-0.3.39/qube/examples/booster/test_portfolio_task.yml`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/examples/learn/filters.py` & `Qube2-0.3.39/qube/examples/learn/filters.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/examples/learn/generators.py` & `Qube2-0.3.39/qube/examples/learn/generators.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/examples/learn/transformers.py` & `Qube2-0.3.39/qube/examples/learn/transformers.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/examples/strategies/test_strategies.py` & `Qube2-0.3.39/qube/examples/strategies/test_strategies.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/examples/strategies/turtles.py` & `Qube2-0.3.39/qube/examples/strategies/turtles.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/learn/advanced/labeling.py` & `Qube2-0.3.39/qube/learn/advanced/labeling.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/learn/core/base.py` & `Qube2-0.3.39/qube/learn/core/base.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/learn/core/data_utils.py` & `Qube2-0.3.39/qube/learn/core/data_utils.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/learn/core/metrics.py` & `Qube2-0.3.39/qube/learn/core/metrics.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/learn/core/mlhelpers.py` & `Qube2-0.3.39/qube/learn/core/mlhelpers.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/learn/core/operations.py` & `Qube2-0.3.39/qube/learn/core/operations.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/learn/core/pickers.py` & `Qube2-0.3.39/qube/learn/core/pickers.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/learn/core/utils.py` & `Qube2-0.3.39/qube/learn/core/utils.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/portfolio/PortfolioLogger.py` & `Qube2-0.3.39/qube/portfolio/PortfolioLogger.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/portfolio/Position.py` & `Qube2-0.3.39/qube/portfolio/Position.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/portfolio/allocating.py` & `Qube2-0.3.39/qube/portfolio/allocating.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/portfolio/commissions.py` & `Qube2-0.3.39/qube/portfolio/commissions.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/portfolio/drawdown.py` & `Qube2-0.3.39/qube/portfolio/drawdown.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/portfolio/performance.py` & `Qube2-0.3.39/qube/portfolio/performance.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/portfolio/report_templates/old_report.tpl` & `Qube2-0.3.39/qube/portfolio/report_templates/old_report.tpl`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/portfolio/report_templates/optimizer_report.tpl` & `Qube2-0.3.39/qube/portfolio/report_templates/optimizer_report.tpl`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/portfolio/report_templates/simple_report.tpl` & `Qube2-0.3.39/qube/portfolio/report_templates/simple_report.tpl`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/portfolio/reports.py` & `Qube2-0.3.39/qube/portfolio/reports.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/portfolio/signals_analysis.py` & `Qube2-0.3.39/qube/portfolio/signals_analysis.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/quantitative/fast_ols.py` & `Qube2-0.3.39/qube/quantitative/fast_ols.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/quantitative/stats/cointegration.py` & `Qube2-0.3.39/qube/quantitative/stats/cointegration.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/quantitative/stats/ssa.py` & `Qube2-0.3.39/qube/quantitative/stats/ssa.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/quantitative/stats/stats.py` & `Qube2-0.3.39/qube/quantitative/stats/stats.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/quantitative/ta/bands.py` & `Qube2-0.3.39/qube/quantitative/ta/bands.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/quantitative/ta/dtw.py` & `Qube2-0.3.39/qube/quantitative/ta/dtw.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/quantitative/ta/indicators.py` & `Qube2-0.3.39/qube/quantitative/ta/indicators.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/quantitative/ta/kalman.py` & `Qube2-0.3.39/qube/quantitative/ta/kalman.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/quantitative/ta/pewma.py` & `Qube2-0.3.39/qube/quantitative/ta/pewma.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/quantitative/ta/swings/reversals.py` & `Qube2-0.3.39/qube/quantitative/ta/swings/reversals.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/quantitative/ta/swings/swings_splitter.py` & `Qube2-0.3.39/qube/quantitative/ta/swings/swings_splitter.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/quantitative/tools.py` & `Qube2-0.3.39/qube/quantitative/tools.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/qube_nb_magic_init.py` & `Qube2-0.3.39/qube/qube_nb_magic_init.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/series/BarSeries.py` & `Qube2-0.3.39/qube/series/BarSeries.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/series/DoubleSeries.py` & `Qube2-0.3.39/qube/series/DoubleSeries.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/series/Indicators.py` & `Qube2-0.3.39/qube/series/Indicators.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/series/Quote.py` & `Qube2-0.3.39/qube/series/Quote.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/series/Series.py` & `Qube2-0.3.39/qube/series/Series.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/simulator/Brokerage.py` & `Qube2-0.3.39/qube/simulator/Brokerage.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/simulator/SignalTester.py` & `Qube2-0.3.39/qube/simulator/SignalTester.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/simulator/backtester.py` & `Qube2-0.3.39/qube/simulator/backtester.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/simulator/core.py` & `Qube2-0.3.39/qube/simulator/core.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/simulator/management.py` & `Qube2-0.3.39/qube/simulator/management.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/simulator/multiproc.py` & `Qube2-0.3.39/qube/simulator/multiproc.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/simulator/multisim.py` & `Qube2-0.3.39/qube/simulator/multisim.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/simulator/tracking/sizers.py` & `Qube2-0.3.39/qube/simulator/tracking/sizers.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/simulator/tracking/trackers.py` & `Qube2-0.3.39/qube/simulator/tracking/trackers.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/simulator/tracking/trailings.py` & `Qube2-0.3.39/qube/simulator/tracking/trailings.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/simulator/utils.py` & `Qube2-0.3.39/qube/simulator/utils.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/DateUtils_test.py` & `Qube2-0.3.39/qube/tests/DateUtils_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/booster/booster_test.py` & `Qube2-0.3.39/qube/tests/booster/booster_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/data/EURUSD.csv` & `Qube2-0.3.39/qube/tests/data/EURUSD.csv`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/data/FDI_test.csv` & `Qube2-0.3.39/qube/tests/data/FDI_test.csv`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/data/test_mdf.py` & `Qube2-0.3.39/qube/tests/data/test_mdf.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/datasource/DataSource_test.py` & `Qube2-0.3.39/qube/tests/datasource/DataSource_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/datasource/KdbConnector_test.py` & `Qube2-0.3.39/qube/tests/datasource/KdbConnector_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/datasource/MemcacheController_test.py` & `Qube2-0.3.39/qube/tests/datasource/MemcacheController_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/datasource/MongoConnector_test.py` & `Qube2-0.3.39/qube/tests/datasource/MongoConnector_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/datasource/MongoController_test.py` & `Qube2-0.3.39/qube/tests/datasource/MongoController_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/ds_test_cfg.json` & `Qube2-0.3.39/qube/tests/ds_test_cfg.json`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/learn/base_test.py` & `Qube2-0.3.39/qube/tests/learn/base_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/learn/scoring_test.py` & `Qube2-0.3.39/qube/tests/learn/scoring_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/ntp_test.py` & `Qube2-0.3.39/qube/tests/ntp_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/portfolio/commissions_test.py` & `Qube2-0.3.39/qube/tests/portfolio/commissions_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/portfolio/drawdown_test.py` & `Qube2-0.3.39/qube/tests/portfolio/drawdown_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/portfolio/portfolio_allocating_test.py` & `Qube2-0.3.39/qube/tests/portfolio/portfolio_allocating_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/portfolio/portfolio_performance_test.py` & `Qube2-0.3.39/qube/tests/portfolio/portfolio_performance_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/properties_test.py` & `Qube2-0.3.39/qube/tests/properties_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/quantitative/coint_test.csv` & `Qube2-0.3.39/qube/tests/quantitative/coint_test.csv`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/quantitative/cointegration_test.py` & `Qube2-0.3.39/qube/tests/quantitative/cointegration_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/quantitative/dtw_test.py` & `Qube2-0.3.39/qube/tests/quantitative/dtw_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/quantitative/indicators_test.py` & `Qube2-0.3.39/qube/tests/quantitative/indicators_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/quantitative/kalman_test.py` & `Qube2-0.3.39/qube/tests/quantitative/kalman_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/quantitative/tools_test.py` & `Qube2-0.3.39/qube/tests/quantitative/tools_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/series/BarSeries_test.py` & `Qube2-0.3.39/qube/tests/series/BarSeries_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/series/Indicator_demo_test.py` & `Qube2-0.3.39/qube/tests/series/Indicator_demo_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/series/Indicator_test.py` & `Qube2-0.3.39/qube/tests/series/Indicator_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/simulator/Position_test.py` & `Qube2-0.3.39/qube/tests/simulator/Position_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/simulator/signal_tester_test.py` & `Qube2-0.3.39/qube/tests/simulator/signal_tester_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/simulator/signal_tracker_cloning_test.py` & `Qube2-0.3.39/qube/tests/simulator/signal_tracker_cloning_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/simulator/signal_tracker_test.py` & `Qube2-0.3.39/qube/tests/simulator/signal_tracker_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/simulator/strategy_tester_test.py` & `Qube2-0.3.39/qube/tests/simulator/strategy_tester_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/simulator/test_multiproc.py` & `Qube2-0.3.39/qube/tests/simulator/test_multiproc.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/simulator/test_multisim.py` & `Qube2-0.3.39/qube/tests/simulator/test_multisim.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/simulator/trackers_test.py` & `Qube2-0.3.39/qube/tests/simulator/trackers_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/simulator/utilities.py` & `Qube2-0.3.39/qube/tests/simulator/utilities.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/simulator/utils_test.py` & `Qube2-0.3.39/qube/tests/simulator/utils_test.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/tests/utils_for_tests.py` & `Qube2-0.3.39/qube/tests/utils_for_tests.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/utils/DateUtils.py` & `Qube2-0.3.39/qube/utils/DateUtils.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/utils/QubeLogger.py` & `Qube2-0.3.39/qube/utils/QubeLogger.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/utils/nb_functions.py` & `Qube2-0.3.39/qube/utils/nb_functions.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/utils/ntp.py` & `Qube2-0.3.39/qube/utils/ntp.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/utils/ui_utils.py` & `Qube2-0.3.39/qube/utils/ui_utils.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/qube/utils/utils.py` & `Qube2-0.3.39/qube/utils/utils.py`

 * *Files identical despite different names*

### Comparing `Qube2-0.3.38/setup.py` & `Qube2-0.3.39/setup.py`
